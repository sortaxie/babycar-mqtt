...
public class FaceMatch {
    ...
    public static String match() {
        ...
        try {
            ...
            byte[] bytes1 = FileUtil.readFileByBytes("E:/b.jpg");
            byte[] bytes2 = FileUtil.readFileByBytes("E:/c.jpg");
         ...
         //   map2.put("liveness_control", "NORMAL");
            ...
            String param = JacksonUtil.toJson(images);

            // 注意这里仅为了简化编码每一次请求都去获取access_token，线上环境access_token有过期时间， 客户端可自行缓存，过期后重新获取。
            String accessToken = "24.fe4487e0ce4c10b28a864f326deee27b.2592000.1553412780.282335-15607213";//AuthService.getAuth();
